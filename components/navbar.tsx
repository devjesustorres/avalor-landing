  ...
  return (
    <header className="fixed top-5 inset-x-0 z-50 flex justify-center px-4 sm:px-6">
      <div className="flex w-full max-w-6xl items-center justify-center gap-2 sm:gap-3">
        ...
        {/* Navigation Links with Specific Clean URLs */}
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <Button
            ...
            className="font-bold text-xs sm:text-sm bg-gradient-to-r from-brand-600 to-brand-500 shadow-neu-btn-blue hover:shadow-lg hover:from-brand-500 hover:to-brand-600 active:shadow-neu-btn-blue-active transition-all px-3.5 sm:px-5 py-2 group text-white"
          >
            {t("nav.quote")}
          </Button>
        </div>
