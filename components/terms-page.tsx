        ...
        <div className="neu-extruded rounded-3xl p-8 sm:p-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                {isEs ? "Saventi • Vigencia 2026" : "Saventi • Active 2026"}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6 text-sm text-slate-600 leading-relaxed">
            <section>
              ...
              <p>
                {isEs
                  ? "Saventi ofrece servicios profesionales de diseño, arquitectura, desarrollo y modernización de software a la medida, plataformas web, aplicaciones móviles y consultoría en infraestructura cloud."
                  : "Saventi provides professional software engineering, custom platform development, mobile applications, and cloud infrastructure consulting."}
              </p>
            </section>
