        ...
        <div className="neu-extruded rounded-3xl p-8 sm:p-12">
          ...
          <div className="space-y-6 text-sm text-slate-600 leading-relaxed">
            <section>
              ...
              <p>
                {isEs
                  ? "En Saventi tratamos la información técnica, comercial y operativa de nuestros clientes bajo estrictos estándares de confidencialidad. Antes de iniciar cualquier proyecto, firmamos un Acuerdo de Confidencialidad (NDA) vinculante."
                  : "At Saventi, we treat all technical, commercial, and operational client data under strict confidentiality. Prior to project kick-off, we execute a legally binding Non-Disclosure Agreement (NDA)."}
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                {isEs
                  ? "Saventi no comercializa, comparte ni utiliza para terceros ningún repositorio de código, base de datos ni secreto comercial desarrollado para sus clientes. Todos los activos digitales pertenecen 100% al cliente."
                  : "Saventi never sells, shares, or utilizes for third parties any source code repositories, databases, or trade secrets built for its clients. All digital deliverables belong 100% to the client."}
              </p>
            </section>
          </div>
        </div>
