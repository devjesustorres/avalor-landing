      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col items-center md:items-end gap-2.5">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-end gap-x-4 gap-y-1 text-xs text-slate-500 font-medium">
              <a href="tel:+584147708179" className="hover:text-blue-600 transition-colors font-semibold flex items-center gap-1">
              ...
              <span>•</span>
              <span className="text-slate-400">Valencia, VE</span>
            </div>
          </div>
