...
import { ArrowLeft, Terminal, ArrowRight, ShieldCheck } from "lucide-react";
        ...
        <div className="mt-16 max-w-5xl mx-auto text-center">
          <div className="neu-extruded rounded-[2.5rem] p-8 sm:p-14 bg-white/70 backdrop-blur-md">
            <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
              {isEs ? "¿Listo para digitalizar la operativa de tu empresa?" : "Ready to digitize your company's operations?"}
            </h2>
            <p className="mt-3 text-slate-600 text-base sm:text-lg max-w-2xl mx-auto">
              {isEs
                ? "Diseñamos la arquitectura y la implementamos bajo un modelo ágil con entregas periódicas y soporte continuo."
                : "We design the architecture and implement it using an agile methodology with continuous releases and dedicated support."}
            </p>
            <div className="mt-8">
              <a
                href={contactHref}
              ...
              >
                {isEs ? "Solicitar Diagnóstico Técnico" : "Request Technical Assessment"}
